...
;
; 16 pixels wide ROM (0x0000 - 0x6FFF) / RAM sprites
;
...
sp1_bdec1:
	...
	ld    r4,      Z+      ; (23) Color 2
	ld    r5,      Z+      ; (25) Color 3
	brmi  sp1_4mir         ; (26 / 27) Mirroring flag
	cpi   YH,      0x71    ; (27)
	brcc  sp1_4mra         ; (28 / 29)
	movw  ZL,      YL      ; (29)
	lpm   r22,     Z+      ; (32)
...
sp1_bdec3:
	...
	ld    r4,      Z+      ; (23) Color 2
	ld    r5,      Z+      ; (25) Color 3
	brmi  sp1_3mir         ; (26 / 27) Mirroring flag
	cpi   YH,      0x71    ; (27)
	brcc  sp1_3mra         ; (28 / 29)
	movw  ZL,      YL      ; (29)
	lpm   r22,     Z+      ; (32)
...
sp1_bdec5:
	...
	sbi   SYNC,    SYNC_P  ; ( 141) Sync pulse goes high
	; -----------------
	brmi  sp1_2mir         ; (26 / 27) Mirroring flag
	cpi   YH,      0x71    ; (27)
	brcc  sp1_2mra         ; (28 / 29)
	movw  ZL,      YL      ; (29)
	lpm   r22,     Z+      ; (32)
...
sp1_2end:
	...
	ld    r4,      Z+      ; (23) Color 2
	ld    r5,      Z+      ; (25) Color 3
	brmi  sp1_1mir         ; (26 / 27) Mirroring flag
	cpi   YH,      0x71    ; (27)
	brcc  sp1_1mra         ; (28 / 29)
	movw  ZL,      YL      ; (29)
	lpm   r22,     Z+      ; (32)
...
sp1_1end:
	...
	ld    r4,      Z+      ; (23) Color 2
	ld    r5,      Z+      ; (25) Color 3
	brmi  sp1_0mir         ; (26 / 27) Mirroring flag
	cpi   YH,      0x71    ; (27)
	brcc  sp1_0mra         ; (28 / 29)
	movw  ZL,      YL      ; (29)
	lpm   r22,     Z+      ; (32)
