...
sp2_bdec1:
	...
	ld    r4,      Z+      ; (23) Color 2
	ld    r5,      Z+      ; (25) Color 3
	brpl  sp2_5nor         ; (26 / 27) Mirroring flag
	cpi   YH,      0xF1    ; (27)
	brcc  sp2_5mra         ; (28 / 29)
	movw  ZL,      YL      ; (29)
	lpm   r21,     Z+      ; (32)
...
sp2_bdec3:
	...
	adc   YH,      r1
	ld    r5,      Z+      ; (25) Color 3
	brpl  sp2_4nor         ; (26 / 27) Mirroring flag
	cpi   YH,      0xF1    ; (27)
	brcc  sp2_4mra         ; (28 / 29)
	movw  ZL,      YL      ; (29)
	lpm   r21,     Z+      ; (32)
...
sp2_bdec5:
	...
	ld    r4,      Z+      ; (23) Color 2
	ld    r5,      Z+      ; (25) Color 3
	brpl  sp2_3nor         ; (26 / 27) Mirroring flag
	cpi   YH,      0xF1    ; (27)
	brcc  sp2_3mra         ; (28 / 29)
	movw  ZL,      YL      ; (29)
	lpm   r21,     Z+      ; (32)
...
sp2_3end:
	...
	ld    r4,      Z+      ; (23) Color 2
	ld    r5,      Z+      ; (25) Color 3
	brpl  sp2_2nor         ; (26 / 27) Mirroring flag
	cpi   YH,      0xF1    ; (27)
	brcc  sp2_2mra         ; (28 / 29)
	movw  ZL,      YL      ; (29)
	lpm   r21,     Z+      ; (32)
...
sp2_2end:
	...
	ld    r4,      Z+      ; (23) Color 2
	ld    r5,      Z+      ; (25) Color 3
	brpl  sp2_1nor         ; (26 / 27) Mirroring flag
	cpi   YH,      0xF1    ; (27)
	brcc  sp2_1mra         ; (28 / 29)
	movw  ZL,      YL      ; (29)
	lpm   r21,     Z+      ; (32)
...
sp2_1end:
	...
	ld    r4,      Z+      ; (23) Color 2
	ld    r5,      Z+      ; (25) Color 3
	brpl  sp2_0nor         ; (26 / 27) Mirroring flag
	cpi   YH,      0xF1    ; (27)
	brcc  sp2_0mra         ; (28 / 29)
	movw  ZL,      YL      ; (29)
	lpm   r21,     Z+      ; (32)
