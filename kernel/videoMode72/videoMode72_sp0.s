...
sp0_0ina:
	brne  sp0_0nnx         ; (11 / 12)
	rcall sp0_0next        ; (69)
	WAIT  YL,      3 - 1   ; (72) (-1 for compensating padding in sp0_0next)
	rjmp  sp0_0end         ; (74)
sp0_0nnx:
	WAIT  YL,      11
	; --- (Display) ---
...
sp0_3ina:
	brne  sp0_3nnx         ; (11 / 12)
	rcall sp0_3next        ; (69)
	WAIT  YL,      3 - 1   ; (72) (-1 for compensating padding in sp0_3next)
	rjmp  sp0_3end         ; (74)
sp0_3nnx:
	WAIT  YL,      44
	; --- (Display) ---
...
sp0_6ina:
	brne  sp0_6nnx         ; (11 / 12)
	rcall sp0_6next        ; (69)
	WAIT  YL,      3 - 1   ; (72) (-1 for compensating padding in sp0_6next)
	rjmp  sp0_6end         ; (74)
sp0_6nnx:
	WAIT  YL,      27
	; --- (Display) ---
